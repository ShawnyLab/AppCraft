...
struct TextOptionView: View {
    ...
    enum ACPosition: String, Identifiable, CaseIterable {
        ...
        var image: Image {
            switch self {
            case .center:
                AppCraftCoreUIAsset.icPositionCenterWhite.swiftUIImage
            case .left:
                AppCraftCoreUIAsset.icPositionLeftWhite.swiftUIImage
            case .right:
                AppCraftCoreUIAsset.icPositionRightWhite.swiftUIImage
            }
        }
    }
